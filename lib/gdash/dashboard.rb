class GDash
  class Dashboard
    ...
    def initialize(graphite_base, short_name, graph_templates, category, options={}, graphite_render="")
      raise "Cannot find dashboard directory #{graph_templates}" unless File.directory?(graph_templates)
